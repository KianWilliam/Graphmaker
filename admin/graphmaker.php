...
JLoader::register('GraphmakerHelper', JPATH_COMPONENT . '/helpers/graphmaker.php');
$document = JFactory::getDocument();
$document->addStyleDeclaration('.icon-24-graphmaker{background-image:url(../media/com_graphmaker/icon-24-graphmaker.png)}');
$controller = JControllerLegacy::getInstance('graphmaker');
