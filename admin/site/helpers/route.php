...
abstract class GraphmakerHelperRoute
{
	
	public static function getGraphRoute($id, $catid)
	{
				 		

		$link = 'index.php?option=com_graphmaker&view=graph&id=' . $id;
	...
	public static function getCategoryRoute($catid)
	{
		...
		{
			$link = 'index.php?option=com_graphmaker&view=category&id=' . $id;
		}
